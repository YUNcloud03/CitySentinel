...
/* ========== 2. 執行摘要 ========== */
{
  ...
  const diff = [
    ...
    ["03", "閉環延伸到市民手機", "通報須人工核准才能發布，送達／失敗／重試全程可見，並模擬民眾手機依裝置語言收到疏散指示。", GREEN]];
...
/* ========== 12. Dashboard 設計 ========== */
{
  ...
  const pages = [
    ...
    ["民眾端", "市民收到什麼", "PWS 風格手機模擬，依裝置語言顯示疏散指示"]];
...
/* ========== 14. 多語與民眾端 ========== */
{
  ...
  s.addText("依裝置語言\n自動切換", { x: 9.2, y: 4.15, w: 1.85, h: 0.5, fontSize: 9,
...
/* ========== 17. Demo 劇本 ========== */
{
  ...
  const demo = [
    ...
    ["01:00", "多語通報", "四語內容生成後待核准，核准並發布，SMS 通道失敗後重試成功", GREEN],
    ["01:15", "民眾接收", "切換至民眾端手機，警報依裝置語言跳出疏散指示", GREEN],
